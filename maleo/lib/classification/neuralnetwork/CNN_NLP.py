...
class CNN_NLP(NeuralNetwork):
    ...
    def stopOperation(self):
        print("Convolutional Neural Network for Natural Language Processing with Tensorflow stopped")
    ...
    def train(self):
        ...
        print("Convolutional Neural Network for Natural Language Processing with Tensorflow")
