...
# GUI part Library
from maleo.src.gui.Dialog.SelectClassifierDialog import SelectClassifierDialog
from maleo.src.gui.Dialog.ModuleSettingDialog import ModuleSettingDialog
...
class ClassifierWidget(QWidget):
    ...
    def classifierSettings(self):
        if self.moduleName and self.moduleSettings:
            ...
            self.moduleSettingDialog.setSettings(self.settings)
